...
export default function ViewBill({ ownerEmail, onClose, onSuccess }) {
    ...
    if (loading) {
        return (
            <div className="fixed inset-0 bg-gradient-to-br bg-opacity-50 flex items-center justify-center p-4 z-50">
